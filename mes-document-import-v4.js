(function (root) {
  ...
  function parseText(text, fileName) {
    ...
    const groups = [parsePricePerTon(lines), parseGrossTareNet(lines, text), parseContractRows(lines, text), parseGenericRows(lines, text)];
  ...
  const core = { VERSION, round2, numberValue, unitCode, sourceUnits, normalizeItem, parseText, parseMatrix, compact, headerKey };
