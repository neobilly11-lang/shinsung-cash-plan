(function(){
  ...
  function eventHtml(event){
    var marker=event.time||(event.type==='arrival'?'입항예정':event.type==='departurePlan'?'출항예정':event.type==='departureConfirmed'?'출항확정':'');
