(function(){
  ...
  var typeFilter={purchase:true,arrival:true,sales:true};
  var query='';
  ...
  function allEvents(){
    ...
    return purchaseEvents().concat(arrivalEvents(),salesEvents()).filter(function(event){
  ...
  function openEvent(event){
    var view=event.type==='sales'?'sales':'purchase';
    return "openMesDetail('"+view+"',decodeURIComponent('"+encodeURIComponent(event.id)+"'))";
  }
  function eventHtml(event){
    var marker=event.time||(event.type==='arrival'?'입항예정':'');
